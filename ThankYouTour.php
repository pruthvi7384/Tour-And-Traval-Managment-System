<?php
    ...
    // ============Get Tou Paymet Information From Id=========
        if(isset($_GET['id'])){
            $id = $_GET['id'];
            $sql = mysqli_query($con,"SELECT * FROM tour_book WHERE id= '$id'");
            $data = mysqli_fetch_assoc($sql);
            $tour_det = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM tourpackages WHERE id = '".$data['tour_id']."'"));
            $agency_det = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM admin WHERE id = '".$tour_det['admin_id']."'"));
        }
...
<head>
    ...
    <title>TMS ~ <?php echo $tour_det['PackageName'] ?></title>
    <!-- Google Font -->
            ...
            <div class="border">
                ...
                <div class="donationSlipDody d-flex justify-content center">
                    <div class="donate_info_heading">
                        <ul>
                            <li>
                                Tour Package Booking Id : 
                            </li>
                            <li>
                                Tour Package Name : 
                            </li>
                            <li>
                                Tour Package Provide Agency Name : 
                            </li>
                            <li>
                                Tour Package Amount :
                            </li>
                    ...
                    <div class="donate_info">
                        <ul>
                            ...
                            <li>
                                 <?php echo $tour_det['PackageName']; ?>
                            </li>
                            <li>
                                <?php echo $agency_det['agency_name']; ?>
                            </li>
                            <li>
                                <?php echo $tour_det['PackagePrice'] ?> &#8377;
                            </li>
                            <li>
                            ...
                            <li>
                                <?php echo date("d F Y h : i : s", strtotime($data['book_at'])) ?>
                            </li>
                        </ul>
                    </div>
                </div>
