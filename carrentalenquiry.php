    ...
    // =========Enquiry Data Submit==========
        ...
        // ======X===If user is login===X========
            ...
            if(isset($_POST['submit'])){
                ...
                mysqli_query($con,"INSERT INTO rental_enquiry(rental_id,admin_id,name,email_id,subject,message) VALUES('$rental_id','$admin_id','$name','$email_id','$subject','$message')");

                $html="
                    <h2 style=' text-align: center; color: #253745'><b style='color: #3fc8fd'>$carrentalname</b> Car Rental Enquiry</h2>
                    <h3 style=' text-align: center; color: #737A80'><strong>Thank You <strong> For Connecting With Us , Will Get Back To You Shortly !</h3>
                ";

                send_email($email_id,$html,'TMS ~ Car Rental Enquiry');
...
<!-- -------------Enquiry Form--------------- -->
    <div class="container signup_form mt-4">
        <div class="row heading" data-aos="fade-down">
            <h2><?php echo $carrentalname; ?> <span style="color: #253745"> Car Rental Enquiry</span></h2>
