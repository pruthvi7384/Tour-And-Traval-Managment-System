<?php 
    ...
    // ==========Get User Id Throw There Tour Package Detaile=========
        if(isset($_GET['id']) && $_GET['id']>0){
            ...
            $row=mysqli_fetch_assoc(mysqli_query($con,"select * from enquiry_tour where id='$id'"));
            $name = $row['name'];
    ...
    // ============Replay To Enquiry============
        if(isset($_POST['submit'])){
            ...
            mysqli_query($con,"UPDATE enquiry_tour SET replay='$replay' WHERE id='$id'");
        
            $html="
                <h2 style=' text-align: center; color: #253745'><b style='color: #3fc8fd'>$name</b> Thank You ! <br> For Connecting With Us !, Your $tour_package_name Tour Package Enquiry Details And Replay Mentioned Below </h2>
                <div>
            ...
            ";
            send_email($email_id,$html,'TMS ~ Tour Package '.$tour_package_name.' Replay');
            echo "<script>
...
?>
    <!-- -------------Contact Us Replay To User Form------------ -->
        <div class="row">
			<h1 class="grid_title ml10 ml15">Tour Enquiry Replay</h1>
